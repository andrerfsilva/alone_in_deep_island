...
An iron bed is a bed in Carla's Cell.

A window is in Carla's Cell. [descrever melhor isso!]
...
A wooden chair is a chair. In the Prison Hall is a man called keeper. The keeper carries the iron key.

An old table is here. "An old wooden table is on the corner. So old and rot that you can even see the trails of termite."
...
The chisel unlocks the carved door.
...
The password unlocks the golden door. [se der, implementar um terminal para digitar senha]
